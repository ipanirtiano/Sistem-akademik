                                    ...
                                    <div class="card-body table-responsive">
                                        <div class="row mb-3 d-flex">
                                            ...
                                            <div class="col-md-2 mb-2" style="margin-right: -10px;">
                                                ...
                                                <form action="<?= base_url(); ?>/printout/print_jadwal_siswa/<?= $kodeSiswa; ?>" method="post">
                                                    <?php csrf_field() ?>
                                        ...
                                        <table class="table table-bordered table-striped table-sm">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($jadwal as $data) : ?>
                                                    ...
                                                    $query2 = mysqli_query($conn, "SELECT * FROM guru WHERE kode_guru = '" . $kodeGuru . "'");
                                                    $data_guru = mysqli_fetch_assoc($query2) ?>
