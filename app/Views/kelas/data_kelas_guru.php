            ...
            <div class="cord shadow rounded">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url(); ?>/views/kelas">Data Kelas</a></li>
                ...
                <div class="card-body table-responsive">
                    <div class="row justify-content-end">
                        <div class="col-md-6 mb-2">
                            <form action="<?= base_url(); ?>/printout/print_form_absen/<?= $kode_kelas; ?>" method="post">
                                <?php csrf_field() ?>
                                <button class="btn btn-outline-dark"> <i class="fa fa-print mr-2" aria-hidden="true"></i> Print Form Absen</button>
                            </form>
                        </div>
                        <div class="col-md-6 mb-2">
