                        ...
                        <tbody>
                            ...
                            <?php foreach ($siswa as $data) : ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="<?= base_url(); ?>/views/input-nilai/<?= $kode_siswa ?>/<?= $kodeGuru; ?>/<?= $kode_kelas; ?>" method="post">
                                            <?php csrf_field() ?>
                                            <button class="btn btn-sm btn-info"><i class="fa fa-pencil mr-2" aria-hidden="true"></i>Input Nilai</button>
                                        </form>
                                    </td>
                                </tr>
                                <?php $i++; ?>
