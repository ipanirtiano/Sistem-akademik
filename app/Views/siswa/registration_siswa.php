            ...
            <div class="cord shadow rounded">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Registration Siswa</li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="col">
                    ...
                    <div class="card shadow">
                        <div class="card-header bg-info text-white">
                            <div class="row">
                                <div class="col">
                                    <i class="fa fas fa-graduation-cap mr-2" aria-hidden="true"></i> Registration Siswa
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <blockquote class="blockquote mb-0">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-12">
                                        <form method="post" action="<?= base_url(); ?>/siswa/proses_regis_siswa">
                                            <?= csrf_field() ?>
                                            <div class="form-group row">
                                                <label for="colFormLabelSm" class="col-sm-2 col-form-label col-form-label-sm">NIS</label>
                                                <div class="col-md-5 mb-2">
                                                    <input type="text" class="form-control form-control-sm <?= ($validation->hasError('nis') ? 'is-invalid' : ''); ?>" id="colFormLabelSm" placeholder="NIS" name="nis" value="<?= $nis; ?>" readonly>
                                                    <div class="invalid-feedback" style="font-size: small">
                                                        <?= $validation->getError('nis'); ?>
                                                    </div>
                                                </div>
                                                <div class="col-md-3 mb-2">
                                                    <input type="text" class="form-control form-control-sm <?= ($validation->hasError('kode_siswa') ? 'is-invalid' : ''); ?>" id="colFormLabelSm" name="kode_siswa" value="<?= $kode_siswa; ?>" readonly>
                                                    <div class="invalid-feedback" style="font-size: small">
