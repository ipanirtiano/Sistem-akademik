                        ...
                        <div class="card-body">
                            <div class="row mb-2 justify-content-center">
                                <div class="col-lg-6">
                                    <div class="card mb-2">
                                        <div class="card-body">
                                            <p style="color: black" class="card-text">NIK : <?= $data_siswa['nis']; ?></p>
                                ...
                                <div class="col-lg-6">
                                    <div class="card mb-2">
                                        <div class="card-body">
                                            ...
                                            <p style="color: black" class="card-text"> Alamat OrangTua : <?= $data_siswa['alamat_orangtua']; ?></p>
                                            <p style="color: black" class="card-text"> Telpon OrangTua : <?= $data_siswa['telpon_orangtua']; ?></p>
                            ...
                            <div class="row justify-content-end">
                                <?php $kode_siswa = base64_encode($data_siswa['kode_siswa']) ?>
                                <a href="<?= base_url(); ?>/view/update/<?= $kode_siswa ?>" class="btn btn-warning btn-sm mr-2"><i class="fa fa-pencil-square-o mr-2" aria-hidden="true"></i>Update Data</a>
                                <a href="<?= base_url(); ?>/view/data-diri/<?= $nis ?>" class="btn btn-info btn-sm mr-2"><i class="fa fa-arrow-left mr-2" aria-hidden="true"></i>Kembali</a>
                            </div>
                        </div>
                    </div>
                </div>
