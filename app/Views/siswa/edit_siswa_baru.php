            ...
            <div class="cord shadow rounded">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url(); ?>/admin/detail-siswa-baru/<?= $kode_siswa; ?>">Detail Siswa Baru</a></li>
                ...
                <div class="col">
                    ...
                    <div class="card shadow">
                        <div class="card-header bg-info text-white">
                            <div class="row">
                                <div class="col">
                                    <i class="fa fa-pencil-square-o mr-2" aria-hidden="true"></i> Edit Data Siswa Baru
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <blockquote class="blockquote mb-0">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-12">
                                        <form method="post" action="<?= base_url(); ?>/siswa/proses_edit_siswa_baru/<?= $kode_siswa; ?>">
                                            <?= csrf_field() ?>
                                            ...
                                            <div class="row px-3 justify-content-end">
                                                ...
                                                <a href="<?= base_url(); ?>/admin/detail-siswa-baru/<?= $kode_siswa; ?>"><button type="button" class="btn btn-danger float-right btn-sm"><i class="fa fa-times mr-2" aria-hidden="true"></i>Batal</button></a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
