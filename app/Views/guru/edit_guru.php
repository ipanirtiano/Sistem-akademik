            ...
            <div class="cord shadow rounded">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url(); ?>/admin/detail/<?= $kode_guru; ?>">Detail Guru</a></li>
                ...
                <div class="col">
                    ...
                    <div class="card shadow">
                        <div class="card-header bg-info text-white">
                            <div class="row">
                                <div class="col">
                                    <i class="fa fa-pencil-square-o mr-2" aria-hidden="true"></i> Edit Data Guru
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <blockquote class="blockquote mb-0">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-12">
                                        <form method="post" action="<?= base_url(); ?>/guru/proses_edit_guru/<?= $kode_guru; ?>">
                                            <?= csrf_field() ?>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-3 mb-2">
                                                    <input type="text" class="form-control form-control-sm <?= ($validation->hasError('kode_guru') ? 'is-invalid' : ''); ?>" id="colFormLabelSm" name="kode_guru" value="<?= $data_guru['kode_guru']; ?>" readonly>
                                                    <div class="invalid-feedback" style="font-size: small">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" class="form-control form-control-sm <?= ($validation->hasError('nip') ? 'is-invalid' : ''); ?>" id="colFormLabelSm" placeholder="NIP" name="nip" value="<?= $data_guru['nip']; ?>">
                                                    <div class="invalid-feedback" style="font-size: small">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" class="form-control form-control-sm <?= ($validation->hasError('namaLengkap') ? 'is-invalid' : ''); ?>" id="colFormLabelSm" placeholder="Nama Lengkap" name="namaLengkap" value="<?= $data_guru['nama_lengkap'] ?>">
                                                    <div class="invalid-feedback" style="font-size: small">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control form-control-sm <?= ($validation->hasError('tempat') ? 'is-invalid' : ''); ?>" id="colFormLabelSm" placeholder="Tempat" name="tempat" value="<?= $data_guru['tempat_lahir'] ?>">
                                                    <div class="invalid-feedback" style="font-size: small">
                                                ...
                                                <div class="col-md-2">
                                                    <select class="form-control form-control-sm mb-2 <?= ($validation->hasError('tanggal') ? 'is-invalid' : ''); ?>" name="tanggal">
                                                        ...
                                                        <?php $ttl = explode(' ', $data_guru['tanggal_lahir']);
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="form-group">
                                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="alamat" value="<?= $data_guru['alamat']; ?>"><?= $data_guru['alamat']; ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row px-3 justify-content-end">
                                                ...
                                                <a href="<?= base_url(); ?>/admin/detail/<?= $kode_guru; ?>"><button type="button" class="btn btn-danger float-right btn-sm"><i class="fa fa-times mr-2" aria-hidden="true"></i>Batal</button></a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
