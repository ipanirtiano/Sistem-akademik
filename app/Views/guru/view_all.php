        ...
        <div class="col">
            <div class="card shadow">
                <div class="card-header bg-info text-white">
                    <i class="fa fas fa-user mr-3" aria-hidden="true"></i> Data Guru
                </div>
                <div class="card-body">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row justify-content-end">
                                <a href="<?= base_url(); ?>/admin/detail/<?= $kode_guru; ?>" class="btn btn-info btn-sm mr-2"><i class="fa fa-arrow-left mr-2" aria-hidden="true"></i>Kembali</a>
                            </div>
                        </div>
                    </div>
                </div>
